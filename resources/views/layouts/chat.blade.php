...
<html >
  <head>
    ...
    <link rel="stylesheet" href="{{asset('chat/css/style1.css')}}">
  </head>

  <body>
    <div class="container clearfix body">
    <div id = 'contact-sidebar-btn' class='is-visible'><i class="fa fa-users"></i></div>
      @include('partials.peoplelist')
      
      <div id='chat_pane' class="chat">
        <div class="chat-header clearfix">
          @if(isset($user))
            <img src="{{asset('/images/rose.jpeg')}}" alt="avatar" />
          @endif
