$(document).ready(function () {
    ...
    $('#contact-sidebar-btn').click(function(e) {
        $('#people-list').toggleClass('is-visible');
        $('#contact-sidebar-btn').toggleClass('is-visible');
    });
    $('#chat_pane.chat').click(function(e) {
        $('#people-list').removeClass('is-visible');
        $('#contact-sidebar-btn').addClass('is-visible');
    });
});
